...
let MatchController = class MatchController {
    ...
    async getTopMatches(eventId, userId) {
...
__decorate([
    (0, common_1.Post)('event/:event_id/accept'),
    __param(0, (0, common_1.Param)('event_id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], MatchController.prototype, "accept", null);
__decorate([
    (0, common_1.Post)('event/:event_id/reject'),
    __param(0, (0, common_1.Param)('event_id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], MatchController.prototype, "reject", null);
