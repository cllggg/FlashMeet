...
let TelemetryController = class TelemetryController {
    ...
    report(body) {
        if (body && 'batch' in body && Array.isArray(body.batch)) {
            for (const item of body.batch) {
                this.service.report(item);
            }
            return { ok: true, queued: body.batch.length };
        }
...
], TelemetryController.prototype, "report", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TelemetryController.prototype, "summary", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], TelemetryController.prototype, "recentErrors", null);
