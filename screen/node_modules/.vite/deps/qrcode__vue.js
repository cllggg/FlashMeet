import { Ft as onMounted, Kn as ref, M as Fragment, U as computed, _n as watchEffect, nt as defineComponent, pt as h } from "./vue.runtime.esm-bundler-CL7UYC5z.js";
...
function useQRCode(props) {
	...
	var imageProps = computed(function() {
		if (!props.imageSettings.src) return {
			x: 0,
			y: 0,
			width: 0,
			height: 0,
...
var QrcodeCanvas = defineComponent({
	...
	setup: function(props, ctx) {
		...
		var generate = function() {
			...
			if (props.imageSettings.src && image && image.naturalWidth !== 0 && image.naturalHeight !== 0) {
